...
public class generalTicket extends base {
	...
	public void initialize() throws Exception {
		...
		String runMode=reader.getCellData(1, 1);
		if(runMode.equalsIgnoreCase("yes")) {
			driver = initializeDriver();
			driver.get(prop.getProperty("url"));
		}
		else if(runMode.equalsIgnoreCase("no")) {
			reader.setCellData(testExecution, "Skipped", 1, 2);
	...
	public void bookTicket() throws Exception {
		...
		String name = reader.getCellData(1, 6);
		String age = reader.getCellData(1, 7);
		String gender = reader.getCellData(1, 8);
		String mobileNo = reader.getCellData(1, 9);
		String address1 = reader.getCellData(1, 10);
		String address2 = reader.getCellData(1, 11);
		String pincode = reader.getCellData(1, 12);
		String postOffice = reader.getCellData(1, 13);
		...
		reader.setCellData(Path, expectedOrigin, 1, 14);
		...
		{
			reader1.setCellData(testExecution, "Pass", 1, 2);
			
		}
		
		else {
			reader1.setCellData(testExecution, "Fail", 1, 2);
		}
